...
If the remote vault is [[Text Editors/obsidian-help/en/Obsidian Sync/Security and privacy|end-to-end encrypted]], collaborators must enter the encryption password when they set up the vault.
